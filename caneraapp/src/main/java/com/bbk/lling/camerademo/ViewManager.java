...
import com.bbk.lling.camerademo.service.MyAccessibilityService;
import com.bbk.lling.camerademo.view.FloatingView;
    ...
    public void showFloatBall() {
        ...
        floatBall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mainActivity.startActivity(new Intent(context, TakePhoteActivity.class));
